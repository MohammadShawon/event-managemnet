                        ...
                        <div class="panel-body">
                            ...
                            <table class="table table-bordered table-hover table-striped middle-align">
                                ...
                                <tr class="center">
                                    ...
                                    <th class="text-center" width="10%">{{'Reg. Date'}}</th>
                                    <th class="text-center" width="10%">{{'Visitor Type'}}</th>
                                    <th class="text-center" width="10%">{{'Name'}}</th>
                                    <th class="text-center" width="5%">{{'Registration Number'}}</th>
                                    ...
                                    <th class="text-center" width="5%">{{'Job Title'}}</th>
                                ...
                                @if (!$usrRegistrations->isEmpty())
                                    ...
                                    @foreach($usrRegistrations as $ur)
                                        <tr>
                                            ...
                                            <td>{{$ur->job_title}}</td>
                                            <td>{{$ur->country_name->nicename}}</td>
                                            <td class="text-center">
                                                @if ($ur->confirmed == 'yes' && $ur->status == 1)
                                            ...
                                            <td class="action-center">
                                                <div class="text-center">
                                                    ...
                                                    <a class="btn btn-primary btn-xs" href="{{ URL::to('user-registration/' . $ur->id . '/view') }}" title="view" target="_blank">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
                                                    <?php } ?>
