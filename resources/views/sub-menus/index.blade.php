                ...
                <div class="hpanel">
                    <div class="panel-heading hbuilt">
                        ...
                        <div class="pull-right">
                            <a class="btn  btn-info" href="{{ URL::to('sub-menus/create') }}">
                        ...
                        <?php } ?>
                        <h3>  {{'CREATE NEW SUB-MENU'}}</h3>
                    </div>
                    <div class="panel-body">
                        <div class="widget-content">
                        <div class="filter-form">
                            {{ Form::open(array('role' => 'form', 'url' => 'sub-menus/filter', 'class' => 'form-horizontal col-md-12')) }}
                                    ...
                                    @if (!$targetArr->isEmpty())
                                        ...
                                        @foreach($targetArr as $target)
                                            ...
                                            <tr class="contain-center">
                                                ...
                                                <td>{{ $target->parent_menu_name->name }}</td>
                                                <td>{{ $target->name }}</td>
                                                <td>{{ $target->url }}</td>
                                                <td>{{ $target->_blank }}</td>
                                                ...
                                                <td class="action-center">
                                                    <div class='text-center'>
                                                        {{ Form::open(array('url' => 'sub-menus/' . $target->id)) }}
                                                        ...
                                                        <a class="btn btn-info btn-xs" href="{{ URL::to('sub-menus/activate/' . $target->id ) }}@if(isset($param)){{'/'.$param }} @endif" data-rel="tooltip" title="@if($target->status_id == '1') Inactivate @else Activate @endif" data-placement="top">
                                                            @if($target->status_id == '1')
                                                        ...
                                                        <a class="btn btn-primary btn-xs" href="{{ URL::to('sub-menus/' . $target->id . '/edit') }}">
                                                            <i class="icon-edit"></i>
                                                        </a>
                                                        <?php } ?>
