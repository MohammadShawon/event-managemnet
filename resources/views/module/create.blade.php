            ...
            <div class="hpanel">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group"><label class="control-label col-xs-12 col-sm-3 no-padding-right" for="description">{!!trans('english.INFO')!!} :</label>
                        <div class="col-md-6">
                            {!!  Form::textarea('description', Input::old('description'), array('id'=> 'description', 'rows' => '3', 'class' => 'form-control')) !!}
                        </div>
                    </div>
                    <div class="form-group"><label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">Activities:<span class="text-danger">*</span></label>
                        <div class="col-md-6">
                            @foreach($activities as $activity)
                                {!!Form::checkbox('activity_id[]',$activity->id, null,['id' => 'activity_id'.$activity->id]) !!} <label for="activity_id{!! $activity->id !!}">{!! $activity->name !!}</label>
                                <br>
                            @endforeach
                        </div>
                    </div>
