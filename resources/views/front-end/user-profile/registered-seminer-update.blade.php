    ...
    <div class="row">
        <div class="col-md-2 col-sm-12 col-xs-12">
          ...
          <div class="col-md-10 col-sm-12 col-xs-12" style="paddin-bottom: 45%;">
            <div class="main">
                @include('layouts.flash')
                <form id="contact-form" name="contact_form" class="default-form" action="{{URL::to('front/front-user-post-upsmnr')}}" method="post">
                    <h1 style="color: #ff1a1a; text-align: center;">Select Seminer To Register Seminer</h1>
                <!--<div class="col-md-4 col-sm-8 col-xs-12">-->
                            ...
                            <div class="col-md-6">
                                <label class="forcheck">{{$si->title}} <br> <span style="font-size: 12px; color: #e6296a;"> {{date('h:i A, M d, Y',strtotime($si->start_date))}} {{'TO'}} {{date('h:i A, M d, Y',strtotime($si->end_date))}} </span>
                                  <input type="checkbox" value="{{$si->id}}" name="seminer_id[]" @foreach($registredSeminer as $rtrds) @if($si->id==$rtrds->seminar_id) {{'checked'}} @endif @endforeach>
