        ...
        <div class="col-md-2 col-sm-12 col-xs-12">
          ...
          <div class="col-md-10 col-sm-12 col-xs-12">
            <div class="main">
                <table class="table table-striped" style="margin-top: 5%; font-size: 14px;">
                  <thead>
                    <tr style="background-color: #4d4dff; color: #f9f9f9;">
                      <th colspan="6"><b>Events that you attended:</b></th>
                    </tr>
                  </thead>
                  <tbody>
                  @if($attendanceEvent->isNotEmpty())
                      <?php
                          $page = Input::get('page');
                          ...
                          $l = 1;
                      ?>
                    @foreach($attendanceEvent as $atn)
                      <tr>
                        <td style="color: #9494b8;">Event Name:</td>
                        <td style="color: #8585ad;"><b>{{$atn->title}}</b></td>
                        <td style="color: #9494b8;">Strat Date:</td>
                        <td style="color: #8585ad;"><b>{{date('F d, Y',strtotime($atn->start_date))}}</b></td>
                        <td style="color: #9494b8;">End Date:</td>
                        <td style="color: #8585ad;"><b>{{date('F d, Y',strtotime($atn->end_date))}}</b></td>
                      </tr>
                    @endforeach
                  @else
                      <tr>
                ...
                {{ $attendanceEvent->appends(Input::all())->links()}}
            </div>
        </div>
      </div>
  </div>
