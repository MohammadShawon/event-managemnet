...
<div class="row">
    <div class="col-md-6">
        <a class="btn btn-link" href="{{URL::to('front/front-user-dashboard')}}" style="color: #8B0000; font-size: 18px;"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back </a>
    </div>
    <div class="col-md-6">
        <p><button type="button" id="printIcon" class="btn btn-info pull-right"><i class="fa fa-print" aria-hidden="true"></i> Print</button></p>
                                ...
                                <div id="nothin">
                                    <div class="center" style="background-image: url('{{ asset('public/uploads/idcard-background-image/Visitor-ID-Card.png') }}'); background-repeat: no-repeat; background-size: 390px 497px;">
                                      <h3>
