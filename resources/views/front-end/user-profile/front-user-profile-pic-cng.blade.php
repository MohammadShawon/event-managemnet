                  ...
                  <section class="contact-section" style="padding-top: 40px !important;">
                      <div class="container">
                          <div class="default-form-area style-three">
                              <form id="" name="contact_form" class="default-form" action="{{url('front/fuppc')}}" method="post" enctype="multipart/form-data">
                                  <div class="row">
                                      <div class="col-md-6 col-sm-6 col-xs-12">
                        
                                          <div class="form-group">
                                              <label>Upload Picture</label>
                                              <input type="file" name="fuppcimg" placeholder="Confirm Password" required="" autocomplete="off">
                                          </div> 
