        ...
        <div class="col-md-2 col-sm-12 col-xs-12">
          ...
          <div class="col-md-10 col-sm-12 col-xs-12">
            <div class="main">
                <table class="table table-striped" width="100%" style="margin-top: 5%; font-size: 14px;">
                  <thead>
                    <tr style="background-color: #4d4dff; color: #f9f9f9;">
                      <th colspan="8"><b>Seminer that you attended:</b></th>
                    </tr>
                  </thead>
                  <tbody>
                  @if($attendanceSeminer->isNotEmpty())
                      <?php
                          $page = Input::get('page');
                          ...
                          $l = 1;
                      ?>
                    @foreach($attendanceSeminer as $ats)
                      <tr>
                        <td style="color: #9494b8;">Event Name:</td>
                        <td style="color: #8585ad;"><b>{{$ats->eventName}}</b></td>
                        <td style="color: #9494b8;">Seminer Name:</td>
                        <td style="color: #8585ad;"><b>{{$ats->title}}</b></td>
                        <td style="color: #9494b8;">Strat Date:</td>
                        <td style="color: #8585ad;"><b>{{date('h:i A M d, Y',strtotime($ats->start_date))}}</b></td>
                        <td style="color: #9494b8;">End Date:</td>
                        <td style="color: #8585ad;"><b>{{date('h:i A M d, Y',strtotime($ats->end_date))}}</b></td>
                      </tr>
                    @endforeach
                  @else
                      <tr>
                ...
                {{ $attendanceSeminer->appends(Input::all())->links()}}
            </div>
        </div>
      </div>
  </div>
