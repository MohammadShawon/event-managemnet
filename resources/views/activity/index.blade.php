        ...
        <div class="col-lg-12">
            <div class="hpanel">
                <div class="panel-heading hbuilt">
                    <?php if(!empty(Session::get('acl')[8][2])){ ?>
                            ...
                            <thead>
                                <tr class="center">
                                    ...
                                    <th>{!!trans('english.INFO')!!}</th>
                                     <?php if(!empty(Session::get('acl')[8][3]) || !empty(Session::get('acl')[8][4])){ ?>
