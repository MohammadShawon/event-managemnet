        ...
        <div class="row">
            <div class="col-sm-6 col-md-12">
                <div class="hpanel">
                    ...
                    <div class="panel-body">
                        {{ Form::model($spkMngId, array('route' => array('speaker-management.update', $spkMngId->id), 'method' => 'PUT', 'files'=> true, 'class' => 'form form-horizontal validate-form', 'id' => 'spemngEdit')) }}
                        ...
                        <div class="form-group"><label class="control-label col-md-4 no-padding-right" for="description">Description :</label>
                            <div class="col-md-5">
                                {{ Form::textarea('description', Input::old('description'), array('id'=> 'description', 'class' => 'form-control g-limit','rows'=>6)) }}
                            </div>
                        </div>
                        ...
                        <div class="form-group"><label class="control-label col-md-4 no-padding-right" for="profile_image">Profile Picture :</label>
                            <div class="col-md-5">
                                ...
                                <div class="row">
                                  ...
                                  @if($spkMngId->profile_image) 
                                    <a href="{!! asset('public/uploads/speaker-profile-image/'.$spkMngId->profile_image) !!}" class="">
                                      <img src="{!! asset('public/uploads/speaker-profile-image/'.$spkMngId->profile_image) !!}" alt="...." width="50%" height="80px">
                                    </a>
                                    @else
