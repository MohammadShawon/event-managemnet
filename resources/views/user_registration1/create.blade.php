                ...
                <div class="hpanel">
                    ...
                    <div class="col-sm-3 col-md-6"> <!-- div 6 second start here -->
                        ...
                        <div class="form-group"><label class="control-label col-md-4 no-padding-right" for="mobile">Mobile :<span class="text-danger">*</span></label>
                            <div class="col-md-8">
                                {{ Form::text('mobile[]', Input::old('mobile'), array('id'=> 'mobile', 'class' => 'form-control g-limit', 'required' => 'true')) }}
                            </div>
                        </div>
                        ...
                        <div class="form-group"><label class="control-label col-md-4 no-padding-right" for="country">Country :</label>
                            <div class="col-md-8">
