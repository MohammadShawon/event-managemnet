        ...
        <div class="col-lg-12">
            <div class="hpanel">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group col-md-6">
                        <label class="col-md-5" for="userRole">{!!trans('english.USER_ROLE')!!} :</label>
                        <div class="col-md-7">
                            {!!Form::select('userRole', $userRole, Input::get('userRole'), array('class' => 'form-control js-source-states', 'id' => 'userRole'))!!}
                        </div>
                    </div>
                    <div class="form-group">
