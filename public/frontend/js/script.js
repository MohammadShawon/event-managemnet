(function($) {
	//alert("eventCountdown: " + eventCountdown);
	"use strict";
...
// 	}	Stop by lemon
   ...
   //9.Gallery masonary style
	...
	//30.Countdown Timer
	if ($('.countdown').length) {
		// eventCountdown variable comes from appsServiceprovider and _script files
	    // $('.countdown').countdown('2018/08/15', function (event) {
	    $('.countdown').countdown(eventCountdown, function (event) {
